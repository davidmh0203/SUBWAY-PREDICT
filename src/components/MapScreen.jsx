...
export function MapScreen({
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-slate-50 pb-20">
      <header className="flex h-14 flex-shrink-0 items-center justify-between border-b border-slate-100 bg-white px-4 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
        <button
          onClick={onBack}
          type="button"
          className="-ml-2 rounded-xl p-2 text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-800"
        >
